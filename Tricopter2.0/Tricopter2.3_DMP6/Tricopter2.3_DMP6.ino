...
#define PID_PITCH_MIN -12
#define PID_PITCH_MAX 12
#define PID_ROLL_MIN -8
#define PID_ROLL_MAX 8
...
void loop()
{
  while (!mpuInterrupt && fifoCount < packetSize) {
    ...
    //if(mpuInterrupt)  updateYawPitchRoll();
    //computePID();
    //if(mpuInterrupt)  updateYawPitchRoll();
    //updateMotors();
  }
