...
void setup()
{
 ...
 /* 
  while(!Serial1.available())  { //wait or port to connect
    tailMotor.write(30);
    rightMotor.write(30);
    leftMotor.write(30);
  ;
 ...
 */
  ...
  //Calibrate Motors
  Serial1.println("Calibrating Motors. Please Wait 5 Seconds");
  delay(5000);
  ...
  {
    Serial1.println("Gyro Connection Lost");
    Serial1.println("Fight Terminated");
    terminateFlight();
  }
  else
  {
    ...
    */
    ...
    {
      Serial1.print("MPU6050 DMP Fatal Error. Error = ");
  ...
  Serial1.println("Tricopter Initialized");
}
...
void updateRadioVariables()
{
   ...
   else
  {
    ...
    {
      Serial1.println("No radio available");
    }
    //Safety Shutdown
...
//while(true) {
   Serial1.println("Flight Terminated");
  //}
}
