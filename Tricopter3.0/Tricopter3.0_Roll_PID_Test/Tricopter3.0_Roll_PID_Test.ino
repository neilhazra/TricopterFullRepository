...
// Global Variables ***********************************
double rollInput; //PID input
double rollOutputLeft,rollOutputRight;   // PID output
...
void loop()
{
   ...
   */
    ...
    rightMotor.write(constrain(30 + map(rollOutputRight,0,100,0,40),30,100));
    leftMotor.write(constrain(30 + map(rollOutputLeft,0,100, 0,40),30,100));  
    tailMotor.write(30);
  }
}
